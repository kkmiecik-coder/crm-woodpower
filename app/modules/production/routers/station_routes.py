# modules/production/routers/station_routes.py
"""
Station Routes dla modułu Production
=====================================
...
logger.info("Zainicjalizowano Station routes dla modułu production", extra={
