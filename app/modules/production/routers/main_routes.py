# modules/production/routers/main_routes.py
"""
Main Routes dla modułu Production
==================================
...
# ============================================================================
# ROUTES - zgodnie z PRD Section 6.1
# ============================================================================
...
def server_error(error):
    ...
    logger.error("Błąd serwera w main routes", extra={
        'user_id': current_user.id if current_user.is_authenticated else None,
        'error': str(error),
        'path': request.path
    })
...
logger.info("Zainicjalizowano Main routes zgodnie z PRD", extra={
    'blueprint_name': main_bp.name,
    'routes_count': 3,  # dashboard, products, config
    'prd_compliance': True
})d