...
def create_app():
    ...
    app.config['SQLALCHEMY_ENGINE_OPTIONS'] = {
        'pool_pre_ping': True,
        'pool_recycle': 3600,           # ZMIANA: 1 godzina zamiast 4.5 min
        'pool_size': 5,                 # ZMIANA: Więcej połączeń
        'max_overflow': 3,              # ZMIANA: Mniej overflow
        'pool_timeout': 10,             # ZMIANA: Krótszy timeout
        'connect_args': {
            'connect_timeout': 5,        # ZMIANA: Szybsze łączenie
            'read_timeout': 15,         # ZMIANA: Szybsze operacje
            'write_timeout': 15,
            'charset': 'utf8mb4',
            'autocommit': False,        # ZMIANA: Wyłącz autocommit
        }
    }
